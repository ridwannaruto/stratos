...
public class PredictedRequestsInFlightEvent extends Event {
    ...
    public PredictedRequestsInFlightEvent(String networkPartitionId, String clusterId,
                                     String clusterInstanceId, double value,String predictedValues) {
